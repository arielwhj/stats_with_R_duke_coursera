...
sim4 <- ames %>%
        ...
        summarise(x_bar = mean(price))
ggplot(data = sim4, aes(x = x_bar)) +xlim(100000, 300000) +
...
sim5 <- ames %>%
        ...
        summarise(x_bar = mean(price))
ggplot(data = sim4, aes(x = x_bar)) +
  geom_histogram(binwidth = 5000) + xlim(100000, 300000)
```
